...
def create_research_workflow(
    ...
    3. extract_entities -> Extract concepts from results
    4. infer_relationships -> Identify relationships between concepts
    5. generate_markdown -> Create Logseq-compatible output
    ...
    workflow.add_edge("extract_entities", "infer_relationships")
